...
const translations = {
  en: {
    ...
    forgotPasswordSuccessMessage: "Password reset instructions sent!",
    forgotPasswordSuccessDesc: "We've sent an email to",
    forgotPasswordCheckEmail: "Please check your inbox and follow the instructions.",
  ...
  vn: {
    ...
    forgotPasswordSuccessMessage: "Đã gửi hướng dẫn đặt lại mật khẩu!",
    forgotPasswordSuccessDesc: "Chúng tôi đã gửi email đến",
    forgotPasswordCheckEmail: "Vui lòng kiểm tra hộp thư và làm theo hướng dẫn.",
